    ...
    return (
      ...
      <div className="content-container">
          ...
          <div id="grid-container">
            ...
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-cover-up"><a href="https://www.mixcloud.com/irisberkeley/playlists/jetset-underground/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-cover-up.png" alt="Jetset Underground" className="grid-img-overlay" /></a></div></div>
