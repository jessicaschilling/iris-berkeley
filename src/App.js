    ...
    return (
      ...
      <div className="content-container">
          ...
          <div id="grid-container">
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-about" onClick={()=>{ document.getElementById('text-about').style.display = 'block'; document.getElementById('grid-container').style.display = 'none'; }}><img src="img/overlay-about.png" className="grid-img-overlay" /></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-afterfm"><a href="http://www.afterfm.com/irisberkeley" target="_blank" rel="noopener noreferrer"><img src="img/overlay-afterfm.png" className="grid-img-overlay" /></a></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-modern-jetset"><a href="https://www.mixcloud.com/irisberkeley/playlists/modern-jetset-radio-1190/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-modern-jetset.png" className="grid-img-overlay" /></a></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-interface-message-processor"><a href="https://www.mixcloud.com/irisberkeley/playlists/interface-message-processor/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-interface-message-processor.png" className="grid-img-overlay" /></a></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner"><img src={evileye} className="evil-eye" alt="Evil-eye logo" /></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-cover-up"><a href="https://www.mixcloud.com/irisberkeley/playlists/the-cover-up-radio-1190/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-cover-up.png" className="grid-img-overlay" /></a></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-other-programs"><a href="https://www.mixcloud.com/irisberkeley/playlists/tasty-miscellany/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-other-shows.png" className="grid-img-overlay" /></a></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-instagram"><a href="https://www.instagram.com/irisberkeley" target="_blank" rel="noopener noreferrer"><img src="img/overlay-instagram.png" className="grid-img-overlay" /></a></div></div>
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-contact" onClick={()=>{ document.getElementById('text-contact').style.display = 'block'; document.getElementById('grid-container').style.display = 'none'; }}><img src="img/overlay-contact.png" className="grid-img-overlay" /></div></div>
          </div>
          ...
          <div id="footer">
            <a target="_blank" rel="license" href="http://creativecommons.org/licenses/by/4.0/"><img src={ccheart} alt="Creative Commons attribution mark" className="cc-heart" /></a> {this.getYear()} Iris Berkeley.
