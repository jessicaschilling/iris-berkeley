    ...
    return (
      ...
      <div className="content-container">
          ...
          <div id="grid-container">
            ...
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-other-programs"><a href="https://www.mixcloud.com/irisberkeley/uploads/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-other-shows.png" alt="Other shows" className="grid-img-overlay" /></a></div></div>
          ...
          <div id="text-about">
            ...
            <p>Iris Berkeley likes to connect the dots: between the music she grew up with and some fab new album from last week, between your favorite song and something you’ve never heard before, between local darlings and sounds from halfway around the world. In 2022, she was voted Readers' Choice for <a href="https://www.westword.com/best-of/2022" target="_blank" rel="noopener noreferrer">Best Radio DJ</a> in Westword's Best of Denver poll.</p>
            <p>On the radio, find Iris on <a href="http://www.kgnu.org" target="_blank" rel="noopener noreferrer">KGNU-FM</a> and <a href="http://www.radio1190.org" target="_blank" rel="noopener noreferrer">Radio 1190</a> (geographically in Boulder, Colorado USA but of course streaming everywhere), plus online on Radio Rethink's <a href="https://www.radiorethink.com/index.cfm/fuseaction/rr.page/pageID/projects-channelone-eclectic.html" target="_blank" rel="noopener noreferrer">Channel One</a>.</p>
