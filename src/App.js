    ...
    return (
      ...
      <div className="content-container">
          ...
          <div id="grid-container">
            ...
            <div className="grid-item-outer"><div className="grid-item-inner grid-img-jetset-underground"><a href="https://www.mixcloud.com/irisberkeley/playlists/jetset-underground/" target="_blank" rel="noopener noreferrer"><img src="img/overlay-jetset-underground.png" alt="Jetset Underground" className="grid-img-overlay" /></a></div></div>
          ...
          <div id="text-about">
            ...
            <p>Since 2020, she's been the <strong>host and producer of <a href="https://modernjetset.com" target="_blank" rel="noopener noreferrer">Modern Jetset</a></strong>, a syndicated hour-long weekly program with a focus on eclectic new releases and the vintage influences that feed them. Listen live every week on a growing list of stations from coast to coast, stream on Radio Rethink's <a href="https://www.radiorethink.com/index.cfm/fuseaction/rr.page/pageID/projects-channelone-eclectic.html" target="_blank" rel="noopener noreferrer">Channel One</a> and KGNU's <a href="http://www.afterfm.com/irisberkeley" target="_blank" rel="noopener noreferrer">AfterFM</a> ... or <strong>grab it for free for your own station</strong> from <a href="https://exchange.prx.org/series/42347-modern-jetset" target="_blank" rel="noopener noreferrer">PRX</a> or <a href="http://audioport.org/index.php?op=producer-info&uid=2866&" target="_blank" rel="noopener noreferrer">AudioPort</a>.</p>
